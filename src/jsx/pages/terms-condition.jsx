                    ...
                    <div className="col-lg-9">
                        <div className="terms_condition-content">
                            <div className="terms_condition-text">
                                ...
                                <p>By using DataProfits.com you agree to and are bound by these Terms and Conditions in
                                    ...
                                    do not agree with any of these terms, you are prohibited from using DataProfits.com.
                                </p>
                            </div>
                            ...
                            <div className="terms_condition-text">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>You must not use DataProfits.com in any way that can cause damage to DataProfits.com
                                    ...
                                    <li>
                                        ...
                                        <p>You must not use this website for any purposes related to marketing without
                                            the permission of DataProfits.com.</p>
                                    </li>
                                    <li>
                                        <i className="fa fa-circle"></i>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p>Account balance may not be transferred, exchanged, sold, or otherwise change
                                            ownership under any circumstances, except by DataProfits.com</p>
                                    </li>
                                    <li>
                                        <i className="fa fa-circle"></i>
                            ...
                            <div className="terms_condition-text">
                                <h3>Indemnity : </h3>
                                <p>You hereby indemnify DataProfits.com and undertake to keep DataProfits.com indemnified
                                    against any losses, damages, costs, liabilities, and/or expenses (including without
                                    limitation legal expenses) and any amounts paid by DataProfits.com
                                    to a third party in settlement of a claim or dispute on the advice of DataProfits.com’s
                                    legal advisers) incurred or suffered by DataProfits.com arising out of any breach by you
                            ...
                            <div className="terms_condition-text">
                                <h3>No warranties : </h3>
                                <p>DataProfits is provided “as is” without any representations or warranties. DataProfits.com
                                ...
                                <p>DataProfits.com does not warrant that:</p>
                            ...
                            <div className="terms_condition-text">
                                <h3>Modifications: </h3>
                                <p>DataProfits.com may revise these terms of use for its website at any time without notice.
                            ...
                            <div className="terms_condition-text">
                                ...
                                <ul>
                                    <li>
                                        <i className="fa fa-circle"></i>
                                        <p>DataProfits.com reserves the rights under these terms and conditions to take
                                            action if you breach these terms and conditions in any way. </p>
                                    </li>
                                    <li>
                                        <i className="fa fa-circle"></i>
                                        <p>DataProfits.com may take such action as seems appropriate to deal with the
                                            breach, including suspending your access to the website, suspending your
                                            earnings made trough DataProfits.com,prohibiting you from accessing the
