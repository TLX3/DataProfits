                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-xl-6 col-lg-6 col-12">
                            <div className="intro-content">
                                <h1>Trade with <strong className="text-primary">DataProfits</strong>. <br /> Algorithmic Cryptocurrency Trading using ML
                            </h1>
                                <p>Fast and secure way to trade 150+ cryptocurrencies</p>
                            </div>
                    ...
                    <div className="row py-lg-5 justify-content-center">
                        <div className="col-xl-7">
                            <div className="section-title text-center">
                                ...
                                <p>DataProfits has a variety of features that make it the best place to start trading</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-6">
                                        <div className="media">
                                            ...
                                            <div className="media-body">
                                                <h4>Mobile apps</h4>
                                                <p>Stay on top of the markets with the DataProfits app for <Link
                                                    to={'#'}>Android</Link>
                                                    or
                                                <Link to={'#'}>iOS</Link>.</p>
                                            </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12">
                            <div className="card trade-app-content">
                                <div className="card-body">
                                    ...
                                    <p>All the power of DataProfits's cryptocurrency exchange, in the palm of your hand. Download
                                        the
                                        DataProfits mobile crypto trading app today</p>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12">
                            <div className="card trade-app-content">
                                <div className="card-body">
                                    ...
                                    <p>Powerful crypto trading platform for those who mean business. The DataProfits crypto
                                        trading
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12">
                            <div className="card trade-app-content">
                                <div className="card-body">
                                    ...
                                    <p>The DataProfits API is designed to provide an easy and efficient way to integrate your
                                        trading
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8">
                            <div className="section-title text-center">
                                ...
                                <p> Here are a few reasons why you should choose DataProfits
                            </p>
                            </div>
                        </div>
                    </div>
                    <div className="row align-items-center py-5">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4">
                            <div className="promo-content">
                                ...
                                <p>DataProfits supports a variety of the most popular digital currencies.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6">
                            <div className="get-touch-content">
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        <h4>Careers</h4>
                                        <p>Help build the future of technology. Start your new career at DataProfits.
                                    </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6">
                            <div className="get-touch-content">
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        <h4>Community</h4>
                                        <p>DataProfits is global. Join the discussion in our worldwide communities.
                                    </p>
                                    </div>
                                </div>
                            </div>
