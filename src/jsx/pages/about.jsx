                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="service-content m-t-50">
                                <h3>In Brief</h3>
                                <p>Founded in January of 2020, DataProfits is a digital currency wallet and platform where
                                    merchants
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="service-content my-5">
                                <h3>Working at DataProfits</h3>
                                <p>Digital currencies are changing how we use and think about money. DataProfits, the most
                                    trusted
