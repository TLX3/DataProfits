                        ...
                        <div className="col-lg-9">
                            <div className="terms_condition-content">
                                <div className="terms_condition-text">
                                    ...
                                    <p>DataProfits is an instant cryptocurrency exchange that allows you to exchange crypto
                                ...
                                <div className="terms_condition-text">
                                    <h3>How does DataProfits work? </h3>
                                    <p>
                                        DataProfits's trading algorithm is integrated into the largest cryptocurrency exchange
                                        platforms, including Binance, Poloniex, Bittrex, etc. In the span of milliseconds,
                                        DataProfits makes bids and asks on the platforms, then selects and suggests the best
                                ...
                                <div className="terms_condition-text">
                                    ...
                                    <p>DataProfits is one of the most prominent instant cryptocurrency exchanges that has
                                ...
                                <div className="terms_condition-text">
                                    <h3>Does DataProfits fix rates? </h3>
                                    <p>DataProfits mobile app does! Mobile app users will no longer be affected by the risks
                                    ...
                                    <p> Alternatively, DataProfits offers our lowest fee of 0.25% for all crypto-to-crypto
